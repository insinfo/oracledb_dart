...
class OpenSslCrypto {
  ...
  int EVP_PKEY_assign_RSA(ffi.Pointer<EVP_PKEY> pkey, ffi.Pointer<RSA> rsa) {
    final fn = _lookup<
        ffi.NativeFunction<
            ffi.Int Function(ffi.Pointer<EVP_PKEY>,
                ffi.Pointer<RSA>)>>('EVP_PKEY_assign_RSA');
    return fn.asFunction<
  ...
  ffi.Pointer<ASN1_TIME> X509_get_notBefore(ffi.Pointer<X509> x) {
    final fn = _lookup<
        ffi.NativeFunction<
            ffi.Pointer<ASN1_TIME> Function(
                ffi.Pointer<X509>)>>('X509_get_notBefore');
    return fn
        .asFunction<ffi.Pointer<ASN1_TIME> Function(ffi.Pointer<X509>)>()(x);
  }

  ffi.Pointer<ASN1_TIME> X509_get_notAfter(ffi.Pointer<X509> x) {
    final fn = _lookup<
        ffi.NativeFunction<
            ffi.Pointer<ASN1_TIME> Function(
                ffi.Pointer<X509>)>>('X509_get_notAfter');
    return fn
        .asFunction<ffi.Pointer<ASN1_TIME> Function(ffi.Pointer<X509>)>()(x);
  }
